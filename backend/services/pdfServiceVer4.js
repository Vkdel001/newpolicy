...
<body>
  ...
  <p class="intro-text">Following the underwriting assessment of your life insurance application dated ${data.applicationDate}, we are pleased to inform you that your proposal has been accepted with revised terms, as outlined below:</p>
  ...
  <table class="options-table">
    ...
    <tr>
      <td>Sum Assured: <strong>${data.sumAssured}</strong></td>
      <td>Adjusted Sum Assured: <strong>${data.option2 || 'MUR [new amount]'}</strong></td>
    </tr>
    <tr>
      <td>New Monthly Premium: <strong>${data.option1 || 'MUR [new amount]'}</strong></td>
      <td>Monthly Premium: <strong>${data.monthlyPremium}</strong> (unchanged)</td>
    </tr>
    <tr>
  ...
  <p style="margin: 10px 0;">Please indicate your preferred option, sign, and return this letter by <strong>${data.returnDate}</strong>.</p>
