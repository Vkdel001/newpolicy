...
const generateQRSection = (qrImagePath) => {
  ...
  try {
    ...
    <div class="qr-instruction">
      <p>For your convenience, you may settle payments instantly via the MauCAS QR Code (Scan to Pay) below using any mobile banking app such as Juice, MauBank WithMe, Blink, MyT Money, or other supported applications.</p>
    </div>
